...
if __name__ == '__main__':
    ...
    y_pred, w = pred_log(logreg, X_train, y_train, X_test, flag=False)
    ...
    y_pred, w_norm_std = pred_log(logreg, X_train, y_train, X_test, flag=False)  # fill it with the nsd function
